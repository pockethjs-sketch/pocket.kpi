...
export default function EmployeeAdministration() {
  ...
  return <div className="p-6 bg-white border rounded-md space-y-4"><h2 className="font-bold text-lg">직원 접근 승인</h2><p className="text-sm text-slate-500">OWNER·ADMIN은 MASTER(전체 권한), EDITOR·VIEWER는 USER로 표시됩니다. 로그인은 각자 승인된 이메일을 사용합니다.</p>
